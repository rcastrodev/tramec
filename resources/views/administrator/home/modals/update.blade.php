<div class="modal fade" id="modal-update-element">
    <form action="{{ route('home.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="content_3" value="" class="form-control" placeholder="Parrafo">
            </div>
            <small>Tamaño recomendado 1366x630</small>
            <div class="form-group">
                <input type="file" name="image" class="form-control-file">
            </div> 
            <small>Tamaño recomendado 235x79</small>
            <div class="form-group">
